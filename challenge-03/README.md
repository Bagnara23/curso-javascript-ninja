...
*/
let pessoa = {nome: 'Rodrigo', sobrenome: 'Bagnara', sexo: 'M', idade: 26, altura: 1.8, peso: 80.0, andando: false, caminhouQuantosMetros: 0}
...
/* Agora vamos brincar um pouco com o objeto criado: Qual o nome completo da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada) */
pessoa.nomeCompleto() // Olá! Meu nome é Rodrigo Bagnara
...
pessoa.apresentacao= function() {
    ...
    pessoaShow += pessoa.nome + ' ' + pessoa.sobrenome + ', tenho ' + pessoa.idade + ' anos, ';
    pessoaShow += pessoa.altura + 'm, meu peso é ' + pessoa.peso + 'Kg, e hoje eu já caminhei ';
    pessoaShow += pessoa.caminhouQuantosMetros + ' metros!';

    console.log(pessoaShow);
}

// Agora, apresente-se ;)
pessoa.apresentacao() // Olá, eu sou o Rodrigo Bagnara, tenho 30 anos, 1.8m, meu peso é 80Kg, e hoje eu já caminhei 45 metros!

(function(){
  ...
  Mostre no console todas as letras do seu nome separadas, com a frase: "[LETRA] é a [POSIÇÃO]ª letra do meu nome."
  ...
  - Detalhe: o código que você escrever abaixo deve funcionar para qualquer nome, então fique à vontade para usar as artimanhas que já viu até agora no
  curso para fazer isso funcionar corretamente :)
  - Mostre no console o nome no formato slug, e o resultado final. Use um console.log para cada formato. */
  console.log( '\nNome convertido à partir de um slug:' );
  let fullName = 'rodrigo-bagnara';
  ...
  console.log( '\nMeus amigos:' );
  let amigos = ['Kaue', 'Luiz', 'Walk', 'Pietro', 'Maike'];
  let meusAmigos = amigos.reduce(function(acumulado, atual, index){
  ...
  /* Usando o replace(), faça a string "Roberto" virar "Roberta". Mostre o resultado no console. */
  console.log( '\nEra "Roberto", agora é:' );
  let name = "Roberto"
  let newName = name.replace('to', 'ta');
  console.log(newName);

  /* Mostre no console a parte "nando" da string "Fernando". Use o método que faz a busca do final para o início da string. */
  console.log( '\nParte de uma string:' );
  let name = 'Fernando';
  let newName = name.replace('Fer', '');
  console.log(newName);

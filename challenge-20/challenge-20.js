(function(){
 ...
 // a marcação criada nele para fazer nosso desafio ;) O HTML NÃO PODE ser alterado!
  ...
  - Se o campo de "Nome" não estiver preenchido, mostrar: "Preencha o nome do usuário!"
  - Se o campo de "Email" não estiver preenchido, mostrar: "Preencha o e-mail!"
  - Se o campo de "Mensagem" não estiver preenchido, mostrar: "Preencha a mensagem!"
  - Se o campo de "Email" for inválido, mostrar: "Entre com um e-mail válido!"

  2. Para verificar se o e-mail é válido use a função `isValidEmail`, passando o e-mail que foi entrado no campo de "Email" por parâmetro.
  (A função `isValidEmail` será criada logo abaixo).

  3. Se tudo estiver OK, pergunte ao usuário: "Tem certeza que deseja enviar o formulário?"
